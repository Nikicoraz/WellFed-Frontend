<script lang="ts">
    ...
    function getImageUrl(imageURL: String): string{
        return import.meta.env.VITE_BACKEND_URL + "/public/images/products/" + imageURL;
    }
</script>
...
<template>
    <div class="card card-side bg-base-100 shadow-sm m-4 overflow-y-scroll cursor-pointer" @click="router.push('/shop/' + product.shopID)">
        <figure>
